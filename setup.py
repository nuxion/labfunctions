...
packages = [
    ...
    "labfunctions.db",
    "labfunctions.db.migrations",
    "labfunctions.db.migrations.versions",
    "labfunctions.errors",
...
extras_require = {
    "cloud": ["smart-open[gcs,s3]>=6.0.0,<7.0.0", "apache-libcloud>=3.5.1,<4.0.0"],
    "server": [
